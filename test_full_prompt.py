"""Test the updated AI dimensioning prompt with Fireworks GLM 5.2."""
import os
import sys
sys.path.insert(0, ".")
...
from src.ai_dim import SYSTEM_PROMPT, _build_user_message, _parse_llm_response
...
print()
print("=== PARSED ===")
result = _parse_llm_response(content, metadata)
print(result)
